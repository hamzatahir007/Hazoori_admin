...
const AddDepartment = () => {
  ...
  useEffect(() => {
    if (isSuccess && createdDepartment) {
      toast.success("Department Added Successfullly!");
    }
    if (isSuccess && updatedDepartment) {
      toast.success("Department Updated Successfullly!");
    ...
    onSubmit: async (values) => {
      try {
        ...
        if (editId) {
          ...
          const updateRes = await dispatch(updateDepartment(updatePayload));
          ...
          const createRes = await dispatch(createNewDepartment(values));
  ...
  return (
    <div>
      <h3 className="mb-4  title">
        {editId !== undefined ? "Edit" : "Add"} Department
      </h3>
      <div>
